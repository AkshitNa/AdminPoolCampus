...
import Blog01X from "../../../assets/Blog/Blog01-01.png"
...
export const AIBlog = () => {
  return (
    ...
    <div className="font-lato">
        ...
        <p className="text-5xl font-semibold pl-10">Quick guide to launching your tech career in AI</p>
        <p className="text-xl pl-10 my-5">Read the advice in this blog and put some thought into what your AI career might look like.</p>
