...
const FreeConsultationFrom = ({ setFreeConsultation }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center md:p-[21rem] font-kumbh py-6">
      ...
      <div className="bg-orange-circle-2 grid grid-cols-1 md:grid-cols-2 gap-4 px-[2.5rem] rounded-xl py-2">


        {/* From */}
        <div className="flex justify-center items-center bg-white min-h-[14rem] font-lato order-2 md:order-1">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-xl p-[1rem]">
        ...
        <div className="order-1 md:order-2">
          <div>
            <button
              ...
              className="absolute right-[3.1rem] top-[1rem]  md:right-[21.5rem] md:top-[5.1rem] text-gray-500 hover:text-gray-700 bg-white rounded-full"
              aria-label="Close"
            >
              <svg
                className="w-6 h-6"
          ...
          <img src={ConsultationFormImg} alt="" className="w-full h-[17rem] md:w-full md:h-auto rounded-xl" />
          {/* Close button */}
        </div>
      </div>
    </div>
