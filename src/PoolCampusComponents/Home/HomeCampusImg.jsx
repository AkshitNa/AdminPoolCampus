...
export const HomeCampusImg = () => {
  return (
    <div className="bg-orange-light min-h-screen md:min-h-0 md:h-auto font-lato py-8 md:py-12">
      {/* Hero Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-8 px-4 md:px-8 lg:px-12">
        {/* Text Content */}
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 lg:gap-8 mt-12 md:mt-16 px-4 md:px-8">
        ...
        <div className="flex items-center bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          <img src={HomeLogo01} alt="Career Stats" className="w-8 h-8 sm:w-10 sm:h-10 mr-3" />
          <div>
        ...
        {/* Card 2 */}
        <div className="flex items-center bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          <img src={HomeLogo02} alt="Education Stats" className="w-8 h-8 sm:w-10 sm:h-10 mr-3" />
          <div>
            <p className="font-semibold text-lg">45000+</p>
            <p className="text-sm text-gray-600">Career Transformed</p>
          </div>
        ...
        {/* Card 3 */}
        <div className="flex items-center bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          <img src={HomeLogo03} alt="Salary Stats" className="w-8 h-8 sm:w-10 sm:h-10 mr-3" />
          <div>
