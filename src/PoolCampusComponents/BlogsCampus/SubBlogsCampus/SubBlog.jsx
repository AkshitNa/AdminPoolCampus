...
import Blog01 from "../../../assets/BlogCampus/BlogCampus01.png";
import Blog02 from "../../../assets/BlogCampus/BlogCampus02.png";
import Blog03 from "../../../assets/BlogCampus/BlogCampus03.png";
  ...
  return (
    <div className="px-5">
      ...
      <p className="text-left font-lato text-2xl sm:text-2xl md:text-2xl font-semibold mt-5">
        See Other <span className="text-btn-green"> Blogs</span>
      </p>
